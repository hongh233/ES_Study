...
function [predictedY, sigma, title] = GP(predictedX, observedX, observedY, theta, kernel, isNormalized, isRegularized, interpolateMode)
    ...
    case 2
        ...
        Ks = exp(-d2/theta);
        Kss = exp(-d3/theta);
        title = 'Regular Exponential Kernel';
    case 3
        % Thin plate spline     
